...
export default function ModalError({ message, onClickButonClose }) {
     const t = useTranslations("ChatAI.Common.ModalError");
        ...
        >
            <div className="flex flex-col justify-center items-center gap-4">
                <div className="flex flex-col justify-center items-center gap-1">
                    <img src="/images/error.png" className="w-20 h-20" />
